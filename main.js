...
const geometry = new THREE.TorusGeometry(10, 3, 16, 4);
const material = new THREE.MeshStandardMaterial({ color: 0x74a8b3, wireframe:true });
...
const cubeTexture = new THREE.TextureLoader().load('cubetex.jpg');

const pic = new THREE.Mesh(
  new THREE.BoxGeometry(3, 3, 3),
   new THREE.MeshStandardMaterial({ 
    map: picTexture,
    normalMap: cubeTexture,
  })
);
